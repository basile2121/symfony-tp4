 ...
 */
final class Version20230131211604 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE possible_answer CHANGE answer answer VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE possible_answer CHANGE answer answer VARCHAR(255) NOT NULL');
